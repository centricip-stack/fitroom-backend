...
JDotScraper
-----------
Scrapes dress listings from j.pk using the Shopify Products JSON API.
"""
...
class JDotScraper(DressScraper):
    """Concrete scraper for j.pk (J. brand) — Shopify JSON API."""
    ...
    def scrape(self, gender: str, color_keywords: list[str]) -> list[DressItem]:
        ...
        # Strategy 1: Attempt handles in order
        ...
        # Strategy 2: Fallback to keyword search if still empty and we have keywords
